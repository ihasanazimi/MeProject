package ir.ha.meproject.common.ui.customViews;
...
public class MaxHeightScrollView extends NestedScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray styledAttrs = context.obtainStyledAttributes(attrs, ir.ha.meproject.R.styleable.MaxHeightScrollView);
            //200 is a defualt value
            maxHeight = styledAttrs.getDimensionPixelSize(ir.ha.meproject.R.styleable.MaxHeightScrollView_maxHeight, defaultHeight);
