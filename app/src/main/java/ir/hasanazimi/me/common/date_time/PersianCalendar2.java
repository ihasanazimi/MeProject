...
import ir.hasanazimi.me.common.date_time.tool.PersianCalendarConst;
import ir.hasanazimi.me.common.date_time.tool.PersianCalendarUtils;
 ...
 * @version 1.1
 */
public class PersianCalendar2 extends GregorianCalendar {
	...
	private long convertToMilis(long julianDate) {
		return PersianCalendarConst.MILLIS_JULIAN_EPOCH + julianDate * PersianCalendarConst.MILLIS_OF_A_DAY
				+ PersianCalendarUtils.ceil(getTimeInMillis() - PersianCalendarConst.MILLIS_JULIAN_EPOCH, PersianCalendarConst.MILLIS_OF_A_DAY);
	}
	 ...
	 */
	public PersianCalendar2(long millis) {
	...
	protected void calculatePersianDate() {
		long julianDate = ((long) Math.floor((getTimeInMillis() - PersianCalendarConst.MILLIS_JULIAN_EPOCH)) / PersianCalendarConst.MILLIS_OF_A_DAY);
	...
	public String getPersianMonthName() {
		// calculatePersianDate();
		return PersianCalendarConst.persianMonthNames[this.persianMonth];
	}
	...
	public String getPersianWeekDayName() {
		...
		case SATURDAY:
			return PersianCalendarConst.persianWeekDays[0];
		case SUNDAY:
			return PersianCalendarConst.persianWeekDays[1];
		case MONDAY:
			return PersianCalendarConst.persianWeekDays[2];
		case TUESDAY:
			return PersianCalendarConst.persianWeekDays[3];
		case WEDNESDAY:
			return PersianCalendarConst.persianWeekDays[4];
		case THURSDAY:
			return PersianCalendarConst.persianWeekDays[5];
		default:
			return PersianCalendarConst.persianWeekDays[6];
		}
	...
	public void parse(String dateString) {
		PersianCalendar2 p = new PersianDateParser(dateString, delimiter).getPersianDate();
